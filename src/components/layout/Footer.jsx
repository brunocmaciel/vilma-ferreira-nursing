  ...
  const handleContactClick = (type) => {
    switch (type) {
      case 'whatsapp':
        ...
        break;
      case 'phone':
        window.open('tel:+5517997194961', '_blank');
        break;
      case 'instagram':
        window.open('https://www.instagram.com/enf.vilma/', '_blank');
        break;
      default:
        break;
    }
    ...
    <footer className="bg-primary text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">Vilma Ferreira</h3>
            <p className="text-white">
              Enfermeira com experiência em cuidados domiciliares, oferecendo atendimento humanizado e profissional.
            </p>
          </div>
            ...
            <ul className="space-y-2">
              <li>
                <button
                  ...
                  className="text-primary transition-colors flex items-center"
                >
        ...
        <div className="mt-8 pt-8 border-t border-white text-center text-white">
          <p>&copy; {new Date().getFullYear()} Vilma Ferreira. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
